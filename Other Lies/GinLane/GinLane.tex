\beginsong{Gin Lane}[by={Other Lies}]
  \textnote{Intro}  
  \lilypondfile[nofragment]{GinLane-Intro.ly}
  \beginverse
  ...
  \endverse
  \beginchorus
  \lilypondfile[nofragment]{GinLane-Chorus.ly}
  ...
  \endchorus
  \textnote{Bridge}  
  \lilypondfile[nofragment]{GinLane-Bridge.ly}
  \beginverse  
  ...
  \endverse
  \textnote{Solo}
  \lilypondfile[nofragment]{GinLane-Solo.ly}
\endsong
