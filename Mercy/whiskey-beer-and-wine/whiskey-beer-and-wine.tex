\beginsong{Whiskey, Beer \& Wine}[by={Buddy Guy}]
  ...
  \beginverse
  \[Cm] Thirsty Begger, \[Cm] written on the door
  \[Cm] That bucket of blood
  \[Cm] Staying open 'til four
  \[F9] Ain't hard to find
  \[F9] A great big neon \[Cm]sign \[Cm]
  They \[Eb]only serve three things
  \[F] Whiskey, beer, and \[Cm]wine \[Cm]
  \endverse
